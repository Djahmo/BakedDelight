package fr.djahmo.bakeddelight.integration.resource;

import fr.djahmo.bakeddelight.BakedDelight;
import fr.djahmo.bakeddelight.custom.recipe.BakingDishRecipe;
import fr.djahmo.bakeddelight.integration.JEIPlugin;
...
public class BakingDishRecipeCategory implements IRecipeCategory<BakingDishRecipe> {
    ...
    public void setRecipe(IRecipeLayoutBuilder builder, BakingDishRecipe recipe, IFocusGroup focuses) {
        ...
        builder.addSlot(RecipeIngredientRole.OUTPUT, 159, 47).addItemStack(recipe.getResultItem());
    }
