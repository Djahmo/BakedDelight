...
public class ModBlocks {
    ...
    static {
        ...
        UNCOOKED_GRATIN_DISH = setBlock("uncooked_gratin_dish", () -> new BakingUncookedDishBlock(BlockBehaviour.Properties.of(Material.STONE).sound(SoundType.STONE).strength(0.4F)));
        COOKED_GRATIN_DISH = setBlock("cooked_gratin_dish", () -> new BakingCookedDishBlock(BlockBehaviour.Properties.of(Material.STONE).sound(SoundType.STONE).strength(0.4F), ModItems.GRATIN_SLICE));
    }
}
